...
def mark_attendance():
    ...
    text_widget.insert(tk.END, "hello")#Inserts text at the end of text widget
    #alternate values: tk.INSERT- insert at current cursor position
    #tk. ACTIVE- insert at selected position
